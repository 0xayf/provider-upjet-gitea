...
PROJECT_NAME ?= provider-upjet-gitea
PROJECT_REPO ?= github.com/0xayf/provider-upjet-gitea
...
export TERRAFORM_PROVIDER_SOURCE ?= go-gitea/gitea
...
xpkg.build.provider-upjet-gitea: do.build.images
