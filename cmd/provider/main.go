...
import (
	...
	"github.com/0xayf/provider-upjet-gitea/config"
	"github.com/0xayf/provider-upjet-gitea/internal/clients"
	controllerCluster "github.com/0xayf/provider-upjet-gitea/internal/controller/cluster"
	controllerNamespaced "github.com/0xayf/provider-upjet-gitea/internal/controller/namespaced"
	"github.com/0xayf/provider-upjet-gitea/internal/features"
	"github.com/0xayf/provider-upjet-gitea/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Gitea APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced Gitea APIs to scheme")
