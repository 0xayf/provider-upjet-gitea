...
type MembershipInitParameters struct {
	...
	// (String) The username of the team member.
...
// Membership is the Schema for the Memberships API. gitea_team_membership manages a single user's membership of a single team.
