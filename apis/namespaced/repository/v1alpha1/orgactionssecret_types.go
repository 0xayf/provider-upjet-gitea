...
// OrgActionsSecret manages an organisation-scoped Gitea Actions secret. The
// authenticated principal in the referenced ProviderConfig must have org
// owner rights (or be a site admin).
