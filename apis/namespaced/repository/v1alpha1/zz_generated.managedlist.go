...
// GetItems of this OrgActionsSecretList.
func (l *OrgActionsSecretList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this UserActionsSecretList.
func (l *UserActionsSecretList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
