...
func (tr *Repository) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"migration_service_auth_password": "migrationServiceAuthPasswordSecretRef", "migration_service_auth_token": "migrationServiceAuthTokenSecretRef"}
}
