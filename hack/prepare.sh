...
REPLACE_FILES='./* ./.github :!build/** :!go.* :!hack/prepare.sh :!hack/bootstrap.sh :!hack/build.sh :!hack/generate.sh :!hack/lib.sh :!hack/test.sh'
...
mv "cluster/images/upjet-provider-template" "cluster/images/provider-${PROVIDER_NAME_LOWER}"
